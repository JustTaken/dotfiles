...
vim.api.nvim_create_autocmd('LspAttach', {
  callback = function(args)
	...
	vim.keymap.set('n', '<Space>s', function() vim.lsp.buf.document_symbol() end, {buffer = args.buf})
	vim.keymap.set('n', '<Space>S', function() vim.lsp.buf.workspace_symbol() end, {buffer = args.buf})
  end,
})
