local M = require("themes/ayu-dark") -- The selected theme
require("statusline")
...
vim.api.nvim_set_hl(0, "FoldColumn", { fg = M.c.base03, bg = nil})
...
vim.api.nvim_set_hl(0, "MatchParen", { fg = M.c.base03, bg = nil})
...
vim.api.nvim_set_hl(0, "StatusLine", { fg = M.c.base05, bg = M.c.base01})
...
vim.api.nvim_set_hl(0, "TabLine", { fg = M.c.base07, bg = nil})
vim.api.nvim_set_hl(0, "TabLineFill", { fg = M.c.base03, bg = nil})
vim.api.nvim_set_hl(0, "TabLineSel", { fg = M.c.base07, bg = M.c.base01})
...
vim.api.nvim_set_hl(0, "Constant", { fg = M.c.base09, bg = nil, bold = true})
...
vim.api.nvim_set_hl(0, "Function", { fg = M.c.base0D, bg = nil, bold = true})
vim.api.nvim_set_hl(0, "Identifier", { fg = M.c.base07, bg = nil})
...
vim.api.nvim_set_hl(0, "Search", { fg = M.c.base01, bg = M.c.base0A})
vim.api.nvim_set_hl(0, "Substitute", { fg = M.c.base01, bg = M.c.base0A})
vim.api.nvim_set_hl(0, "Todo", { fg = base0A, bg = M.c.base01})
